...
# C - 菱型カウント
  ...
  [問題はこちら](https://atcoder.jp/contests/abc018/tasks/abc018_3)


## 発想

  各点について、上に連続する白マスが何個あるかを数える。<br>
  各点について、下に連続する白マスが何個あるかを数える。<br>
  各点について横一列に見て、上下方向に一定マス以上白マスがあるかをチェックする。
