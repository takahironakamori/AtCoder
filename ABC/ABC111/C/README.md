...
# C - /\/\/\/
  ...
  [問題はこちら](https://atcoder.jp/contests/abc111/tasks/arc103_a)


## 発想

  偶数番目で使われている数字と奇数番目で使われている数字を分けて配列を作り、それぞれの数値が何回使われているかを数える。<br>
  そして、偶奇の配列で最も使われている数値と2番目に使われている数値を並び替えなどで取得する。<br>
  - 最も多い数が偶奇で異なる場合はそれぞれ N ÷ 2 - 使われている回数を足した数が回答となる。<br>
  - 最も多い数が偶奇で同じ場合、どちらかの配列の要素数が1つの場合は、N ÷ 2 - 他方の2番目に使われている数字の回数が回答となる。<br>
  - 上記以外の場合は、次の【パターン1】と【パターン2】で小さい方が回答となる。<br>
    【パターン1】 偶数番目は最も多い数値に変える、奇数番目は2番目に多い数値に変える場合の変更回数<br>
    【パターン2】 偶数番目は2番目に多い数値に変える、奇数番目は最も多い数値に変える場合の変更回数<br>
