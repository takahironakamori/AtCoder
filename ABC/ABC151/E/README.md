...
- 発想<br>
  ...
  7 を最大値する 3 個の組み合わせは、<sub>4</sub>C<sub>3</sub>個となる。
  したがって、maxX の合計は、<sub>n</sub>C<sub>k</sub> × A\[i]でいい。<br>
  最小値となる組み合わせの数は、A を逆にソートして同じ計算をすればいい。<br>
  <sub>n</sub>C<sub>k</sub> (mod p)はライブラリから求めることができる。<br>
