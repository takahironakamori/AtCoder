...
# C - HonestOrUnkind2
  ...
  [問題はこちら](https://atcoder.jp/contests/abc147/tasks/abc147_c)


## 発想

  1からN人まで正直者のパターンを全部試す。<br>
  正直者であると仮定して、証言に矛盾がなければそのときのパターンの正直者の数の最大値が回答となる。<br>
  全パターンはbit全探索で作ることができる。<br>
